...
<body>
    ...
    <main>
        <div class="container my-5 d-flex align-items-center flex-column justify-content-center " style="height: 55vh">
            <h1 class="text-center fw-bold my-5 ">Contact Us</h1>
            <p class="text-center">Silahkan hubungi kami di toko furniture kami untuk informasi lebih lanjut atau untuk memesan produk yang Anda inginkan. Tim kami yang ramah dan profesional siap membantu Anda dalam menciptakan ruang yang indah dan nyaman. Dapatkan pengalaman belanja yang menyenangkan dan layanan yang terbaik dengan menghubungi kami hari ini.</p>
        </div>
        </div>
    </main>
